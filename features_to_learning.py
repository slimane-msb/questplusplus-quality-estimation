filename = "output/test/output_lm.txt"
file_rank_path = "input/training/tgt1/target.sent-level_rank.sp"

train_len = 0.8

def fet_to_learning():
    with open(filename) as file, open(file_rank_path) as file_rank:
